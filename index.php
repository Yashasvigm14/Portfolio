                                ...
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="#service">Internships</a></li>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8">
                            <div class="section-title text-center mb-70">
                                <span></span>
                                <h2>Certifications and Internships</h2>
                            </div>
                        </div>
                    </div>
					<div class="row">
                    ...
                    ?>
                      ...
                      <div class="speaker-box">
      								...
      								<div class="speaker-overlay">
      									...
      									<a href="https://github.com/Yashasvigm14" class="arrow-btn">More information <span></span></a>
      								</div>
      							</div>
                  </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p>Copyright© <span>yashasvi gm</span> | All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
